...
export const typography = {
  ...
  label: 'text-xs font-semibold tracking-wider uppercase text-brand-blue-300',
  // Navigation
...
export const card = {
  ...
  hover: 'hover:border-brand-blue-400/30 hover:shadow-glow hover:-translate-y-0.5',
  padding: 'p-6 sm:p-8',
...
// Button styles
export const button = {
  base: 'inline-flex items-center justify-center rounded-full font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue-400 disabled:opacity-50 disabled:pointer-events-none',
